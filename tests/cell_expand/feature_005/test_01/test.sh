...
# Test 01: Error when @project used without cellproject.toml
...
# Run cell expand @project from directory without cellproject.toml
cd "$TEST_ROOT/subdir"
...
echo "✓ @project without cellproject.toml produces correct error"
exit 0
