...
#### 🟡 Ambiguity #001 - Harness Log Path Collision
- **Severity:** Medium
...
- **Status:** Documented in `001_harness_log_path_collision.md`
- **Recommendation:** Use full relative path from work_root

#### 🟡 Ambiguity #002 - Exit Terminology Inconsistency
- **Severity:** Low
...
- **Status:** Documented in `002_exit_terminology_inconsistency.md`
...
1. **Decide on log path structure** - resolve ambiguity #001
...
2. **Standardize exit terminology** - resolve ambiguity #002
